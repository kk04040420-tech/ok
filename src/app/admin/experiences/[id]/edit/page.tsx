  ...
  return (
    <div>
      ...
      <form action={action} className="space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <FormField label="입사일" name="startDate" type="date" required defaultValue={exp.startDate} />
          <FormField label="퇴사일" name="endDate" type="date" defaultValue={exp.endDate ?? ""} hint="재직 중이면 비워두세요" />
        </div>
        <TextAreaField
          label="업무 설명"
          name="description"
